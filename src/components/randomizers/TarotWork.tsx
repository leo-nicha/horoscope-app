  ...
  return (
    <div className="min-h-screen bg-linear-to-b from-amber-50 to-white flex flex-col items-center p-4 font-sans">
      ...
      <header className="text-center mt-10 mb-6 w-full">
        <h1 className="text-3xl font-extrabold text-amber-700 font-serif flex justify-center items-center gap-2 mb-2">
          <Briefcase className="text-amber-600 w-6 h-6" />
          ไพ่ทำนายการงาน
        </h1>
        <p className="text-sm text-amber-500">เปิดไพ่ Major Arcana เพื่อทำนายด้านอาชีพและงาน</p>
        <p className="text-sm text-amber-500">(เปิดได้วันละ 1 ครั้ง)</p>
      </header>
